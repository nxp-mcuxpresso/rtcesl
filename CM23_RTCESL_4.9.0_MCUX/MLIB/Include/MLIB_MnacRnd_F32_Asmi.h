...
#define MLIB_MnacRndSat_F32_AsmRam(f32Accum, f32Mult1, f32Mult2)                  \
        MLIB_MnacRndSat_F32_FAsmRam(f32Accum, f32Mult1, f32Mult2)		
...
RAM_FUNC_LIB
extern frac32_t MLIB_MnacRndSat_F32_FAsmRam(register frac32_t f32Accum, 
                                            register frac32_t f32Mult1, register frac32_t f32Mult2);										 
