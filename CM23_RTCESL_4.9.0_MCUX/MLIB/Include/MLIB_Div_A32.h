...
#define MLIB_Div_A32ll_C(f32Num, f32Denom)     MLIB_Div_A32ll_FC(f32Num, f32Denom)
#define MLIB_Div_A32ll_CRam(f32Num, f32Denom)  MLIB_Div_A32ll_FCRam(f32Num, f32Denom)

/*******************************************************************************
* Exported function prototypes
*******************************************************************************/
extern acc32_t MLIB_Div_A32ll_FC(frac32_t f32Num, frac32_t f32Denom);
RAM_FUNC_LIB
extern acc32_t MLIB_Div_A32ll_FCRam(frac32_t f32Num, frac32_t f32Denom); 
