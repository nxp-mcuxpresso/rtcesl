...
RAM_FUNC_LIB 
RTCESL_INLINE static inline frac16_t MLIB_ShLBiSat_F16_FAsmi(register frac16_t f16Val, register int16_t i16Sh)
{
...
RTCESL_INLINE_OPTIM_SET
RAM_FUNC_LIB 
RTCESL_INLINE static inline frac16_t MLIB_ShRBiSat_F16_FAsmi(register frac16_t f16Val, register int16_t i16Sh)
{
