...
#define MLIB_Div1QSat_F16ll(f32Num, f32Denom)                   MLIB_Div1QSat_F16ll_CRam(f32Num, f32Denom)
#define MLIB_Div1QSat_F32(f32Num, f32Denom)                     MLIB_Div1QSat_F32_CRam(f32Num, f32Denom)  
...
#define MLIB_Div1Q_A32ll(f32Num, f32Denom)                      MLIB_Div1Q_A32ll_CRam(f32Num, f32Denom)  
#define MLIB_Div1Q_F16ll(f32Num, f32Denom)                      MLIB_Div1Q_F16ll_CRam(f32Num, f32Denom)
#define MLIB_Div1Q_F32(f32Num, f32Denom)                        MLIB_Div1Q_F32_CRam(f32Num, f32Denom)  
...
#define MLIB_DivSat_F16(f16Num, f16Denom)                       MLIB_DivSat_F16_CRam(f16Num, f16Denom)  
#define MLIB_DivSat_F16ll(f32Num, f32Denom)                     MLIB_DivSat_F16ll_CRam(f32Num, f32Denom)  
#define MLIB_DivSat_F32(f32Num, f32Denom)                       MLIB_DivSat_F32_CRam(f32Num, f32Denom)  
...
#define MLIB_Div_A32ll(f32Num, f32Denom)                        MLIB_Div_A32ll_CRam(f32Num, f32Denom)
#define MLIB_Div_F16ll(f32Num, f32Denom)                        MLIB_Div_F16ll_CRam(f32Num, f32Denom) 
#define MLIB_Div_F32(f32Num, f32Denom)                          MLIB_Div_F32_CRam(f32Num, f32Denom)  
...
#define MLIB_Mac4RndSat_F32(f32Add1Mul1, f32Add1Mul2, f32Add2Mul1, f32Add2Mul2) MLIB_Mac4RndSat_F32_AsmRam(f32Add1Mul1, f32Add1Mul2, f32Add2Mul1, f32Add2Mul2)
#define MLIB_Mac4Rnd_F32(f32Add1Mul1, f32Add1Mul2, f32Add2Mul1, f32Add2Mul2)    MLIB_Mac4Rnd_F32_AsmRam(f32Add1Mul1, f32Add1Mul2, f32Add2Mul1, f32Add2Mul2)
#define MLIB_MacRndSat_F32( f32Accum, f32Mult1, f32Mult2)                       MLIB_MacRndSat_F32_AsmRam( f32Accum, f32Mult1, f32Mult2)
#define MLIB_MnacRndSat_F32( f32Accum, f32Mult1, f32Mult2)                      MLIB_MnacRndSat_F32_AsmRam( f32Accum, f32Mult1, f32Mult2)
#define MLIB_Msu4RndSat_F32( f32MinMul1, f32MinMul2, f32SubMul1, f32SubMul2)    MLIB_Msu4RndSat_F32_AsmRam( f32MinMul1, f32MinMul2, f32SubMul1, f32SubMul2)
#define MLIB_MsuRndSat_F32( f32Accum, f32Mult1, f32Mult2)                       MLIB_MsuRndSat_F32_AsmRam( f32Accum, f32Mult1, f32Mult2)
#define MLIB_Rcp1Q1_A32s(f16Denom)                              MLIB_Rcp1Q1_A32s_CRam(f16Denom)
#define MLIB_Rcp1Q_A32s(f16Denom)                               MLIB_Rcp1Q_A32s_CRam(f16Denom)
#define MLIB_Rcp1_A32s(f16Denom)                                MLIB_Rcp1_A32s_CRam(f16Denom)
#define MLIB_Rcp_A32s(f16Denom)                                 MLIB_Rcp_A32s_CRam(f16Denom)
#else
#define MLIB_Div1QSat_F16ll(f32Num, f32Denom)                   MLIB_Div1QSat_F16ll_C(f32Num, f32Denom)
#define MLIB_Div1QSat_F32(f32Num, f32Denom)                     MLIB_Div1QSat_F32_C(f32Num, f32Denom)  
...
#define MLIB_Div1Q_A32ll(f32Num, f32Denom)                      MLIB_Div1Q_A32ll_C(f32Num, f32Denom)  
#define MLIB_Div1Q_F16ll(f32Num, f32Denom)                      MLIB_Div1Q_F16ll_C(f32Num, f32Denom)
#define MLIB_Div1Q_F32(f32Num, f32Denom)                        MLIB_Div1Q_F32_C(f32Num, f32Denom)  
...
#define MLIB_DivSat_F16(f16Num, f16Denom)                       MLIB_DivSat_F16_C(f16Num, f16Denom)  
#define MLIB_DivSat_F16ll(f32Num, f32Denom)                     MLIB_DivSat_F16ll_C(f32Num, f32Denom)  
#define MLIB_DivSat_F32(f32Num, f32Denom)                       MLIB_DivSat_F32_C(f32Num, f32Denom)  
...
#define MLIB_Div_A32ll(f32Num, f32Denom)                        MLIB_Div_A32ll_C(f32Num, f32Denom)
#define MLIB_Div_F16ll(f32Num, f32Denom)                        MLIB_Div_F16ll_C(f32Num, f32Denom) 
#define MLIB_Div_F32(f32Num, f32Denom)                          MLIB_Div_F32_C(f32Num, f32Denom)  
...
#define MLIB_Rcp1Q1_A32s(f16Denom)                              MLIB_Rcp1Q1_A32s_C(f16Denom)
#define MLIB_Rcp1Q_A32s(f16Denom)                               MLIB_Rcp1Q_A32s_C(f16Denom)
#define MLIB_Rcp1_A32s(f16Denom)                                MLIB_Rcp1_A32s_C(f16Denom)
#define MLIB_Rcp_A32s(f16Denom)                                 MLIB_Rcp_A32s_C(f16Denom)
...
#define MLIB_Div_F16(f16Num, f16Denom)                          MLIB_Div_F16_C(f16Num, f16Denom) 
