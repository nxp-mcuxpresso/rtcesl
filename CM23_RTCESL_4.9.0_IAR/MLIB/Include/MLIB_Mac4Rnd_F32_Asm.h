...
#define MLIB_Mac4Rnd_F32_AsmRam(f32Add1Mul1, f32Add1Mul2, f32Add2Mul1, f32Add2Mul2)    \
        MLIB_Mac4Rnd_F32_FAsmRam(f32Add1Mul1, f32Add1Mul2, f32Add2Mul1, f32Add2Mul2)
#define MLIB_Mac4RndSat_F32_AsmRam(f32Add1Mul1, f32Add1Mul2, f32Add2Mul1, f32Add2Mul2) \
        MLIB_Mac4RndSat_F32_FAsmRam(f32Add1Mul1, f32Add1Mul2, f32Add2Mul1, f32Add2Mul2)
...
RAM_FUNC_LIB
extern frac16_t MLIB_Mac4Rnd_F32_FAsmRam(frac32_t f32Add1Mul1, frac32_t f32Add1Mul2, 
                                         frac32_t f32Add2Mul1, frac32_t f32Add2Mul2);
									  
extern frac16_t MLIB_Mac4RndSat_F32_FAsm(frac32_t f32Add1Mul1, frac32_t f32Add1Mul2, 
                                         frac32_t f32Add2Mul1, frac32_t f32Add2Mul2);
RAM_FUNC_LIB
extern frac16_t MLIB_Mac4RndSat_F32_FAsmRam(frac32_t f32Add1Mul1, frac32_t f32Add1Mul2, 
                                            frac32_t f32Add2Mul1, frac32_t f32Add2Mul2);
