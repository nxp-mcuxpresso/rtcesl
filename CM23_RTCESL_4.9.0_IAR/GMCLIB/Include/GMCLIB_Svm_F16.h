...
#define GMCLIB_SvmStd_F16_AsmRam(psIn, psOut)                           GMCLIB_SvmStd_F16_FAsmRam(psIn, psOut)
...
extern uint16_t GMCLIB_SvmStd_F16_FAsm(const GMCLIB_2COOR_ALBE_T_F16 *psIn, GMCLIB_3COOR_T_F16 *psOut);
RAM_FUNC_LIB 
extern uint16_t GMCLIB_SvmStd_F16_FAsmRam(const GMCLIB_2COOR_ALBE_T_F16 *psIn, GMCLIB_3COOR_T_F16 *psOut);
