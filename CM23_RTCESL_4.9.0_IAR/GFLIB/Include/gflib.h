...
#define GFLIB_DFlexRampInit_F16(f16InitVal, psParam)                           GFLIB_DFlexRampInit_F16_Ci(f16InitVal, psParam)
#define GFLIB_FlexRampInit_F16(f16InitVal, psParam)                            GFLIB_FlexRampInit_F16_Ci(f16InitVal, psParam)
...
#define GFLIB_UpperLimit_F32(f32Val, f32ULim)                                  GFLIB_UpperLimit_F32_Ci(f32Val, f32ULim)
...
#else /* RAM_RELOCATION not defined */
  ...
  #endif /* RAM_RELOCATION end */
#endif /* RTCESL_MAU end */
