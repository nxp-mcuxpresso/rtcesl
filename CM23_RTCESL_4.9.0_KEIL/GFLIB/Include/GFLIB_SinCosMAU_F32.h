...
*
*******************************************************************************/
RTCESL_INLINE static inline frac16_t GFLIB_SinMAU_F16_FCi(register frac16_t f16Angle, register uint8_t u8ResReg)
{
    #if defined(__GNUC__)
...
*
*******************************************************************************/ 
RTCESL_INLINE static inline frac16_t GFLIB_CosMAU_F16_FCi(register frac16_t f16Angle, register uint8_t u8ResReg)
{
    #if defined(__GNUC__)
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wstrict-aliasing"
...
*
*******************************************************************************/ 
RTCESL_INLINE static inline void GFLIB_SinCosMAU_F16_FCi(register frac16_t f16Angle, GMCLIB_2COOR_SINCOS_T_F16 *f16SinCos, register uint8_t u8ResRegSin, register uint8_t u8ResRegCos)
{   
