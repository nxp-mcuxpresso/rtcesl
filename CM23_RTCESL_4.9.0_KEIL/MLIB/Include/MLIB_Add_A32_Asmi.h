...
RAM_FUNC_LIB 
RTCESL_INLINE static inline acc32_t MLIB_Add_A32ss_FAsmi(register frac16_t f16Add1, register frac16_t f16Add2)
{ 
...
RTCESL_INLINE_OPTIM_SET
RAM_FUNC_LIB 
RTCESL_INLINE static inline acc32_t MLIB_Add_A32as_FAsmi(register acc32_t a32Accum, register frac16_t f16Add)
{ 
    #if defined(__CC_ARM)                                 /* For ARM Compiler */
