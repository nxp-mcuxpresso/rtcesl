...
The libraries are currently available for the Kinetis ARM Cortex M0+, M4, M7 and M33
...
FSLESL 4.5. use API Translator. This simple tool will help migrate your code by
