...
extern inline frac32_t MLIB_Mac4RndSat_F32_FAsmi(register frac32_t f32Add1Mult1, register frac32_t f32Add1Mult2, register frac32_t f32Add2Mult1, register frac32_t f32Add2Mult2)
{
	...
	asm(mpy64 f32Add1Mult1,f32Add1Mult2,f32Add1Mult2);	/* f32Val1:Y = f32Add1Mult1 * f32Add1Mult2 */
	
	asm(tfr	Y,f32Add1Mult1);						    /* f32Add1Mult1 = Y */
	
	asm(mpy64 f32Add2Mult1,f32Add2Mult2,f32Add2Mult2);	/* f32Val2:Y = f32Add2Mult1 * f32Add2Mult2 */
	
	asm(add f32Add1Mult2,f32Add2Mult2);				    /* f32Val1 = f32Val1 + f32Val2 */
	...
	asm(adc	Y,f32Add2Mult2);							/* f32Val1 = f32Val1 + Rounding Bit + Carry Bit */
	
	asm(sat f32Add2Mult2);								/* Saturation */
