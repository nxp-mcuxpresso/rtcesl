...
#include "GFLIB_AtanYXCORDIC_F32.h"
#include "GFLIB_Atan_F32_AsmDef.h"
#include "GFLIB_AtanCORDIC_F32.h"
...
#include "GFLIB_SinCosCORDIC_F32.h"
#include "GFLIB_Sqrt_F32_AsmDef.h"
#include "GFLIB_SqrtCORDIC_F32.h"
#include "GFLIB_SqrtCORDIC_F16.h"
...
#if (RTCESL_CORDIC)  
  #define GFLIB_Cos_F16(f16Angle)                                              GFLIB_CosCORDIC_F16_Ci(f16Angle)
  #define GFLIB_Sin_F16(f16Angle)                                              GFLIB_SinCORDIC_F16_Ci(f16Angle)
  #define GFLIB_Sqrt_F16(f16Val)                                               GFLIB_SqrtCORDIC_F16_Ci(f16Val)
  #define GFLIB_Sqrt_F16l(f32Val)                                              GFLIB_SqrtCORDIC_F16l_Ci(f32Val)
  #define GFLIB_Atan_F16(f16Val)                                               GFLIB_AtanCORDIC_F16_Ci(f16Val)
  #define GFLIB_AtanYX_F16(f16Y,f16X, pbErrFlag)                               GFLIB_AtanYXCORDIC_F16_Ci(f16Y, f16X, pbErrFlag)
#else /* RTCESL_CORDIC */ 
