...
* Macros 
*******************************************************************************/
#define GFLIB_SqrtMAU_FLT_Ci(fltVal, ui8ResReg) GFLIB_SqrtMAU_FLT_FCi(fltVal, ui8ResReg)
...
*
****************************************************************************/  
static inline float_t GFLIB_SqrtMAU_FLT_FCi(register float_t fltVal, register uint8_t ui8ResReg)
{
    ...
    {        
        ...
        addr = RTCESL_MAU_IND_ADDR((uint32_t)RTCESL_MAU_BASE_PTR, RTCESL_MAU_DT_FLOAT, ui8ResReg, RTCESL_MAU_MOPC_SQRT);
